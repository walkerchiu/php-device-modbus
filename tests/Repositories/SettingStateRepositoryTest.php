...
use WalkerChiu\DeviceModbus\Models\Repositories\SettingStateRepository;

class SettingStateRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->app->make(SettingStateRepository::class);
    }
    ...
    /**
     * A basic functional test on SettingStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testSettingStateRepository()
    {
        // Config
    ...
    /**
     * Unit test about Lang creation on SettingStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\SettingStateRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_setting = factory(Setting::class)->create(['main_id' => $db_main->id]);
        factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(SettingStateLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on SettingStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\SettingStateRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_setting = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_morph_1 = factory(SettingState::class)->create(['setting_id' => $db_setting->id, 'is_enabled' => 1]);
        $db_morph_2 = factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
        $db_morph_3 = factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
        $db_morph_4 = factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
    ...
    /**
     * Unit test about Query List on SettingStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\SettingStateRepository
     *
    ...
    public function testQueryList()
    {
        ...
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_setting = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_morph_1 = factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
        $db_morph_2 = factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
        $db_morph_3 = factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
        $db_morph_4 = factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
    ...
    /**
     * Unit test about FormTrait on SettingStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\SettingStateRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $db_morph_1 = factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
            $db_morph_2 = factory(SettingState::class)->create(['setting_id' => $db_setting->id]);
            $db_lang_1 = $this->repository->createLangWithoutCheck(['setting_id' => $db_setting->id, 'morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $db_lang_2 = $this->repository->createLangWithoutCheck(['setting_id' => $db_setting->id, 'morph_id' => $db_morph_2->id, 'morph_type' => SettingState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(SettingState::class)->create(['setting_id' => $db_setting->id, 'serial' => '123', 'identifier' => 'A123']);
            $db_morph_4 = factory(SettingState::class)->create(['setting_id' => $db_setting->id, 'serial' => '124', 'identifier' => 'A124']);
            $db_morph_5 = factory(SettingState::class)->create(['setting_id' => $db_setting->id, 'serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    /**
     * Unit test about Auto Complete on SettingStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\SettingStateRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_setting = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_morph_1 = factory(SettingState::class)->create(['setting_id' => $db_setting->id, 'serial' => 'A123', 'is_enabled' => 1]);
        $db_morph_2 = factory(SettingState::class)->create(['setting_id' => $db_setting->id, 'serial' => 'A124', 'is_enabled' => 1]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $db_lang_3 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $db_lang_4 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $db_lang_5 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $db_lang_6 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
