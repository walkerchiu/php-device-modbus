...
use WalkerChiu\DeviceModbus\Models\Repositories\SettingRepository;
...
class SettingRepositoryTest extends \Orchestra\Testbench\TestCase
{
     ...
     *     WalkerChiu\DeviceModbus\Models\Repositories\SettingRepository
     * 
     * @return void
     */
    ...
    public function testEnableAndDisable()
    {
        ...
        $db_channel = factory(Channel::class)->create();
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_morph_1 = factory(Setting::class)->create(['main_id' => $db_main->id, 'main_id' => $db_main->id, 'is_enabled' => 1]);
        $db_morph_2 = factory(Setting::class)->create(['main_id' => $db_main->id, 'main_id' => $db_main->id]);
        $db_morph_3 = factory(Setting::class)->create(['main_id' => $db_main->id, 'main_id' => $db_main->id]);
        $db_morph_4 = factory(Setting::class)->create(['main_id' => $db_main->id, 'main_id' => $db_main->id]);
    ...
    public function testQueryList()
    {
        ...
        $db_channel = factory(Channel::class)->create();
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_morph_1 = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_morph_2 = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_morph_3 = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_morph_4 = factory(Setting::class)->create(['main_id' => $db_main->id]);
    ...
    public function testFormTrait()
    {
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(Setting::class)->create(['main_id' => $db_main->id, 'serial' => '123', 'identifier' => 'A123']);
            $db_morph_4 = factory(Setting::class)->create(['main_id' => $db_main->id, 'serial' => '124', 'identifier' => 'A124']);
            $db_morph_5 = factory(Setting::class)->create(['main_id' => $db_main->id, 'serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    public function testAutoComplete()
    {
        ...
        $db_channel = factory(Channel::class)->create();
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_morph_1 = factory(Setting::class)->create(['main_id' => $db_main->id, 'serial' => 'A123', 'is_enabled' => 1]);
        $db_morph_2 = factory(Setting::class)->create(['main_id' => $db_main->id, 'serial' => 'A124', 'is_enabled' => 1]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $db_lang_3 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $db_lang_4 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $db_lang_5 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $db_lang_6 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
