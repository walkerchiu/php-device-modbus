...
use WalkerChiu\DeviceModbus\Models\Repositories\MainStateRepository;

class MainStateRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->app->make(MainStateRepository::class);
    }
    ...
    /**
     * A basic functional test on MainStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testMainStateRepository()
    {
        // Config
    ...
    /**
     * Unit test about Lang creation on MainStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\MainStateRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        $db_channel = factory(Channel::class)->create();
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_morph_1 = factory(MainState::class)->create(['main_id' => $db_main->id]);
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(MainStateLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on MainStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\MainStateRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        $db_channel = factory(Channel::class)->create();
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_morph_1 = factory(MainState::class)->create(['main_id' => $db_main->id, 'is_enabled' => 1]);
        $db_morph_2 = factory(MainState::class)->create(['main_id' => $db_main->id]);
        $db_morph_3 = factory(MainState::class)->create(['main_id' => $db_main->id]);
        $db_morph_4 = factory(MainState::class)->create(['main_id' => $db_main->id]);
    ...
    /**
     * Unit test about Query List on MainStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\MainStateRepository
     *
    ...
    /**
     * Unit test about FormTrait on MainStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\MainStateRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $db_morph_1 = factory(MainState::class)->create(['main_id' => $db_main->id]);
            $db_morph_2 = factory(MainState::class)->create(['main_id' => $db_main->id]);
            $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => MainState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(MainState::class)->create(['main_id' => $db_main->id, 'serial' => '123', 'identifier' => 'A123']);
            $db_morph_4 = factory(MainState::class)->create(['main_id' => $db_main->id, 'serial' => '124', 'identifier' => 'A124']);
            $db_morph_5 = factory(MainState::class)->create(['main_id' => $db_main->id, 'serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    /**
     * Unit test about Auto Complete on MainStateRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\MainStateRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        $db_channel = factory(Channel::class)->create();
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_morph_1 = factory(MainState::class)->create(['main_id' => $db_main->id, 'serial' => 'A123', 'is_enabled' => 1]);
        $db_morph_2 = factory(MainState::class)->create(['main_id' => $db_main->id, 'serial' => 'A124', 'is_enabled' => 1]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $db_lang_3 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $db_lang_4 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => MainState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $db_lang_5 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => MainState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $db_lang_6 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => MainState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
