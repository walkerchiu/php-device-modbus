...
class DataRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testcreateLangWithoutCheck()
    {
        ...
        $db_setting = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_address = factory(Address::class)->create(['setting_id' => $db_setting->id]);
        factory(Data::class)->create(['address_id' => $db_address->id]);
    ...
    public function testQueryList()
    {
        ...
        $db_setting = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_address = factory(Address::class)->create(['setting_id' => $db_setting->id]);
        $db_morph_1 = factory(Data::class)->create(['address_id' => $db_address->id]);
        $db_morph_2 = factory(Data::class)->create(['address_id' => $db_address->id]);
        $db_morph_3 = factory(Data::class)->create(['address_id' => $db_address->id]);
        $db_morph_4 = factory(Data::class)->create(['address_id' => $db_address->id]);
