...
use WalkerChiu\DeviceModbus\Models\Repositories\ChannelRepository;

class ChannelRepositoryTest extends \Orchestra\Testbench\TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = $this->app->make(ChannelRepository::class);
    }
    ...
    /**
     * A basic functional test on ChannelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\Repository
     *
     * @return void
     */
    public function testChannelRepository()
    {
        // Config
    ...
    /**
     * Unit test about Lang creation on ChannelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\ChannelRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        // Create Lang
            ...
            // Then
            $this->assertInstanceOf(ChannelLang::class, $lang);
    }

    /**
     * Unit test about Enable and Disable on ChannelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\ChannelRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        $db_morph_1 = factory(Channel::class)->create(['is_enabled' => 1]);
        $db_morph_2 = factory(Channel::class)->create();
        $db_morph_3 = factory(Channel::class)->create();
        $db_morph_4 = factory(Channel::class)->create();
    ...
    /**
     * Unit test about Query List on ChannelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\ChannelRepository
     *
    ...
    public function testQueryList()
    {
        ...
        // Give
        $db_morph_1 = factory(Channel::class)->create();
        $db_morph_2 = factory(Channel::class)->create();
        $db_morph_3 = factory(Channel::class)->create();
        $db_morph_4 = factory(Channel::class)->create();
    ...
    /**
     * Unit test about FormTrait on ChannelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\ChannelRepository
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $db_morph_1 = factory(Channel::class)->create();
            $db_morph_2 = factory(Channel::class)->create();
            $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Channel::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(Channel::class)->create(['serial' => '123', 'identifier' => 'A123']);
            $db_morph_4 = factory(Channel::class)->create(['serial' => '124', 'identifier' => 'A124']);
            $db_morph_5 = factory(Channel::class)->create(['serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    /**
     * Unit test about Auto Complete on ChannelRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\ChannelRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        $db_morph_1 = factory(Channel::class)->create(['serial' => 'A123', 'is_enabled' => 1]);
        $db_morph_2 = factory(Channel::class)->create(['serial' => 'A124', 'is_enabled' => 1]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $db_lang_3 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $db_lang_4 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Channel::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $db_lang_5 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Channel::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $db_lang_6 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Channel::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
