...
use WalkerChiu\DeviceModbus\Models\Repositories\AddressRepository;
...
class AddressRepositoryTest extends \Orchestra\Testbench\TestCase
{
     ...
     * @return void
     */
    public function testAddressRepository()
    {
        // Config
     ...
     *     WalkerChiu\DeviceModbus\Models\Repositories\AddressRepository
     * 
     * @return void
     */
    public function testcreateLangWithoutCheck()
    {
        ...
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_setting = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_address = factory(Address::class)->create(['setting_id' => $db_setting->id]);
    ...
    /**
     * Unit test about Enable and Disable on AddressRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\AddressRepository
     *
    ...
    public function testEnableAndDisable()
    {
        ...
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_setting = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_morph_1 = factory(Address::class)->create(['setting_id' => $db_setting->id, 'is_enabled' => 1]);
        $db_morph_2 = factory(Address::class)->create(['setting_id' => $db_setting->id]);
        $db_morph_3 = factory(Address::class)->create(['setting_id' => $db_setting->id]);
        $db_morph_4 = factory(Address::class)->create(['setting_id' => $db_setting->id]);
    ...
    public function testFormTrait()
    {
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(Address::class)->create(['setting_id' => $db_setting->id, 'serial' => '123', 'identifier' => 'A123']);
            $db_morph_4 = factory(Address::class)->create(['setting_id' => $db_setting->id, 'serial' => '124', 'identifier' => 'A124']);
            $db_morph_5 = factory(Address::class)->create(['setting_id' => $db_setting->id, 'serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    /**
     * Unit test about Auto Complete on AddressRepository.
     *
     * For WalkerChiu\Core\Models\Repositories\RepositoryTrait
     *     WalkerChiu\DeviceModbus\Models\Repositories\AddressRepository
     *
    ...
    public function testAutoComplete()
    {
        ...
        $db_main = factory(Main::class)->create(['channel_id' => $db_channel->id]);
        $db_setting = factory(Setting::class)->create(['main_id' => $db_main->id]);
        $db_morph_1 = factory(Address::class)->create(['setting_id' => $db_setting->id, 'serial' => 'A123', 'is_enabled' => 1]);
        $db_morph_2 = factory(Address::class)->create(['setting_id' => $db_setting->id, 'serial' => 'A124', 'is_enabled' => 1]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Address::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Address::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $db_lang_3 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Address::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $db_lang_4 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Address::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $db_lang_5 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => Address::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $db_lang_6 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => Address::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
