...
use WalkerChiu\DeviceModbus\Models\Forms\MainStateFormRequest;

class MainStateFormRequestTest extends \Orchestra\Testbench\TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->request  = new MainStateFormRequest();
     ...
     *
     * For WalkerChiu\DeviceModbus\Models\Forms\MainStateFormRequest
     * 
     * @return void
     */
