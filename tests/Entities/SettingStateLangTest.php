...
class SettingStateLangTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testSettingStateLang()
    {
        ...
        $db_lang_1 = factory(SettingStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = factory(SettingStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'description']);
        $db_lang_3 = factory(SettingStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'zh_tw', 'key' => 'description']);
        $db_lang_4 = factory(SettingStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_5 = factory(SettingStateLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => SettingState::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_6 = factory(SettingStateLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => SettingState::class, 'code' => 'zh_tw', 'key' => 'description']);
        ...
        // Get record's morph
            // When
            $record = SettingStateLang::find($db_lang_1->id);
            // Then
    ...
    public function testSettingState()
    {
        ...
        // Get lang of record
            // When
            $record_1 = SettingState::find($db_morph_1->id);
            $lang_1   = SettingStateLang::find($db_lang_1->id);
            $lang_4   = SettingStateLang::find($db_lang_4->id);
            // Then
        ...
        // Get lang's histories of record
            ...
            $record_2 = SettingState::find($db_morph_2->id);
