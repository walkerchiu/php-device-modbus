...
class SettingLangTest extends \Orchestra\Testbench\TestCase
{
     ...
     *     WalkerChiu\DeviceModbus\Models\Entities\SettingLang
     *
     * @return void
     */
    public function testSettingLang()
    {
        ...
        $db_lang_1 = factory(SettingLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = factory(SettingLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'description']);
        $db_lang_3 = factory(SettingLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'zh_tw', 'key' => 'description']);
        $db_lang_4 = factory(SettingLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_5 = factory(SettingLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Setting::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_6 = factory(SettingLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Setting::class, 'code' => 'zh_tw', 'key' => 'description']);
        ...
        // Get record's morph
            // When
            $record = SettingLang::find($db_lang_1->id);
            // Then
    ...
    public function testSetting()
    {
        ...
        // Get lang of record
            // When
            $record_1 = Setting::find($db_morph_1->id);
            $lang_1   = SettingLang::find($db_lang_1->id);
            $lang_4   = SettingLang::find($db_lang_4->id);
            // Then
        ...
        // Get lang's histories of record
            ...
            $record_2 = Setting::find($db_morph_2->id);
