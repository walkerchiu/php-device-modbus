...
class ChannelTest extends \Orchestra\Testbench\TestCase
{
    ...
    /**
     * A basic functional test on Channel.
     *
     * For WalkerChiu\DeviceModbus\Models\Entities\Channel
     * 
     * @return void
     */
    public function testChannel()
    {
        ...
        $db_morph_3 = factory(Channel::class)->create(['is_enabled' => 1]);
        ...
        // Return Lang class
            ...
            $class = $record_2->lang();
            // Then
            $this->assertEquals($class, ChannelLang::class);

        // Scope query on enabled records
            // When
            $records = Channel::ofEnabled()
                              ->get();
            // Then
